...
class User extends \UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'firstName', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'familyName', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'phoneNumber', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'address', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'image', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'batch', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'userCategory', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'studentID', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'specialty', '' . "\0" . 'UserBundle\\Entity\\User' . "\0" . 'book_user', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
