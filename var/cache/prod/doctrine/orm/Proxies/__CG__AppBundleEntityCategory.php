...
class Category extends \AppBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'categoryCode', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'categoryName', '' . "\0" . 'AppBundle\\Entity\\Category' . "\0" . 'subcategories'];
        }
