   ...
   // }
    ...
    public function buildForm( FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
           ...
           -> add('coverPicture', ImageType::class, array('required'=> false,'attr' => array('data_class'=>'AppBundle\Entity\Image','class' => 'form-control', 'style' => 'margin-bottom:30px')))

           -> add('summary', SummaryType::class, array('required'=> false, 'attr' => array('data_class'=>'AppBundle\Entity\Image', 'class' => 'form-control', 'style' => 'margin-bottom:30px')))
