...
class RegistrationType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        ->add('plainPassword', LegacyFormHelper::getType('Symfony\Component\Form\Extension\Core\Type\RepeatedType'), array(
            ...
            'first_options' => array('label' => 'Password', 'attr'=>array('class'=>'form-control', 'style'=>'margin-bottom:10px', 'placeholder'=>'at least 8 characters', 'minlength' => 8) ),
            'second_options' => array('label' => 'Password Confirmation', 'attr'=>array('class'=>'form-control', 'style'=>'margin-bottom:10px', 'placeholder'=>'Reenter Password', 'minlength' => 8)),
        ...
        -> add('phoneNumber', TextType::class, array('attr'=>array('class'=>'form-control', 'style'=>'margin-bottom:10px', 'placeholder' => 'must have 9 digits', 'maxlength' => 9 )
            ))        
        ...
        -> add('image', ImageType::class, array('attr'=>array('class'=>'form-control', 'style'=>'margin-bottom:10px', 'placeholder'=>'Choose a photo', 'invalid_message' => 'Upload as image' )))
